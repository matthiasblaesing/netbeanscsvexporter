...
public final class TableImporterVisualPanel3 extends JPanel {
     ...
     */
    public TableImporterVisualPanel3() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        org.openide.awt.Mnemonics.setLocalizedText(message, org.openide.util.NbBundle.getMessage(TableImporterVisualPanel3.class, "TableImporterVisualPanel3.message.text")); // NOI18N
        message.setToolTipText(org.openide.util.NbBundle.getMessage(TableImporterVisualPanel3.class, "TableImporterVisualPanel3.message.toolTipText")); // NOI18N
