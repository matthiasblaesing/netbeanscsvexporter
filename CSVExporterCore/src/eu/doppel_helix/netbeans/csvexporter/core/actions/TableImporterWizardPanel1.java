...
public class TableImporterWizardPanel1 implements WizardDescriptor.Panel<WizardDescriptor> {

    /**
     * The visual component that displays this panel. If you need to access the
     * component from this class, just use getComponent().
     */
    private TableImporterVisualPanel1 component;
    ...
    @Override
    public TableImporterVisualPanel1 getComponent() {
        if (component == null) {
            component = new TableImporterVisualPanel1();
        }
        return component;
    }
